...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card/80 backdrop-blur-xl p-6 shadow-glass transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
